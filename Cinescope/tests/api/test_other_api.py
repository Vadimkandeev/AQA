import pytest
import requests
from constants import BASE_URL, HEADERS, REGISTER_ENDPOINT, CONFIRM_ENDPOINT, LOGIN_ENDPOINT, LOGOUT_ENDPOINT


# Выход из учетной записи и удаление токена
class TestLogout:
    def test_logout_user(self, test_user, created_user, tokens):
        ...
        assert response_data == "OK", "Тело ответ не верно"
