...
class TestCreateMovie:
    # Создаем афишу
    def test_create_movie(self, auth_admin_headers, created_data_movie, session_factory, admin_tokens):
    ...
    def test_negative_create_movie_by_unlegal_token(self, auth_admin_headers, created_data_movie, session_factory, user_tokens):
    ...
    def test_negative_create_movie_duplicate_mane(self, auth_admin_headers, created_data_movie, session_factory, admin_tokens):
