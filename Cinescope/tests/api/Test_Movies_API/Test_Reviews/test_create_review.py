...
class TestCreateReview:
    ...
    def test_create_review(self, auth_admin_headers, created_movie, created_body_from_review):
    ...
    # Создаем отзыв на фильм
    def test_create_review_for_deleted_movie(self, auth_admin_headers, created_movie, created_body_from_review):
        response_body = created_movie
    ...
    def test_negative_duplicate_create_review(self, auth_admin_headers, created_movie, created_body_from_review):
        ...
        requests.post(url_create_review, json=created_body_from_review, headers=auth_admin_headers)
        response = requests.post(url_create_review, json = created_body_from_review, headers=auth_admin_headers)
